...
class MarketCommand extends Command{
   ...
   public function sendConsoleError(CommandSender $sender): void{
      $sender->sendMessage("désoler mais tu ne peut pas faire cette commande de la console ");
   }
      
   public function sendPermissionError(CommandSender $sender): void{
      $sender->sendMessage("désoler mais je ne crois pas que tu as la permission de faire cette commande ");
   }
   ...
   public function sendHelp(CommandSender $sender): void{
      ...
      $sender->sendMessage("§a". "/Market Info"." : "."Market du server Stars ");
